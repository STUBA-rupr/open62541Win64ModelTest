...
#ifndef NAMESPACE_DI_GENERATED_H_
#define NAMESPACE_DI_GENERATED_H_
...
extern UA_StatusCode namespace_di_generated(UA_Server *server);

_UA_END_DECLS

#endif /* NAMESPACE_DI_GENERATED_H_ */
